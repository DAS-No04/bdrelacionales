...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2025 a las 01:27:25
...
--
-- Estructura de tabla para la tabla `carga academica`
--

CREATE TABLE `carga academica` (
  `id` int(11) NOT NULL,
  `clase id` int(11) NOT NULL,
  `alumno id` int(11) NOT NULL,
  `calificacion` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `carga academica`
--

INSERT INTO `carga academica` (`id`, `clase id`, `alumno id`, `calificacion`) VALUES
(1, 4, 5, 8),
(2, 1, 4, 10),
(3, 1, 9, 7),
(4, 8, 8, 5),
...
--
-- Indices de la tabla `carga academica`
--
ALTER TABLE `carga academica`
  ADD PRIMARY KEY (`id`),
  ADD KEY `clase id` (`clase id`),
...
--
-- Filtros para la tabla `carga academica`
--
ALTER TABLE `carga academica`
  ADD CONSTRAINT `carga academica_ibfk_1` FOREIGN KEY (`alumno id`) REFERENCES `alumnos` (`id`),
  ADD CONSTRAINT `carga academica_ibfk_2` FOREIGN KEY (`clase id`) REFERENCES `clases` (`id`);
